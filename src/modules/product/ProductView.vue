...
//   table.options.data = newProducts ?? [];
// });
          ...
          <TableRow v-for="(product, index) in paginatedData" :key="index">
            ...
            <TableCell>
              <div class="flex space-x-4">
                ...
                <Button class="bg-blue-200 text-black-300 hover:bg-gray-300" @click="addToCart(product)"> ➕ Add To
                  Cart</Button>



                <Button variant="destructive" class="hover:bg-gray-300 text-black-300" @click="removeFromCart(product)">
                  ✖️ Remove from Cart</Button>
                <Button class="bg-blue-200  hover:bg-gray-300 text-black-300" @click="openEditDialog(product)">Edit
                  Product</Button>
                <Button class="bg-blue-200  hover:bg-gray-300 text-black-300" @click="del(product.productId)">Delete
                  Product</Button>
              </div>
